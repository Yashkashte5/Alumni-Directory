...
<html lang="en">
    ...
    <style>
    	header.masthead {
		  background: url(admin/assets/uploads/1648286040_bg.jpg);
...
a.jqte_tool_label.unselectable {
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3" id="mainNav">
            <div class="container">
                <a class="navbar-brand js-scroll-trigger" href="./">Alumni Directory</a>
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto my-2 my-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="admin/login.php" id="login">Staff Login</a></li>
                        <?php else: ?>
                        <li class="nav-item">
  ...
  <div class="modal fade" id="viewer_modal" role='dialog'>
    <div class="modal-dialog modal-md" role="document">
      <div class="modal-content">
            ...
            <br>
            <div class="container"><div class="small text-center text-muted"> - Alumni Directory</div></div>
        </footer>
